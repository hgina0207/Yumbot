...
<body>
	<div class="container px-0" style="margin: 0 0;">
		...
		<div class="row" style="width: 1900px; margin: 0 0;">
			<div class="col px-0">
				<div id="carouselExampleInterval" class="carousel slide"
					data-bs-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active" data-bs-interval="10000">
							<img src="/yumbot/resources/img/banner1.png"
								class="d-block w-100" style="height: 560px; object-fit: cover;"
								alt="...">
						</div>
						<div class="carousel-item" data-bs-interval="10000">
							<img src="/yumbot/resources/img/banner2.png"
								class="d-block w-100" style="height: 560px; object-fit: cover;"
								alt="...">
						</div>
					</div>
		...
		<div class="row bg-light" style="width: 1900px; margin: 0 0;">
			<div class="col-2"></div>
			<div class="col">
									...
									<div class="col">
										<div id="carouselAIRanking" class="carousel slide"
											...
											<button
												...
												data-bs-target="#carouselAIRanking"
												data-bs-slide="prev">
												<span class="carousel-control-prev-icon" aria-hidden="true"></span>
												<span class="visually-hidden">Previous</span>
											</button>
																			...
																			<div class="row">
																				<div class="col position-relative px-2">
																					...
																					<span
																						...
																						style="left: 25%; top: 75%; background-color: rgba(0, 0, 0, 0.7);"><span
																						class="text-white" style="opacity: 1;">AI
																							긍정점수</span> <span class="text-info">${restaurantDatas.restaurantData.POSITIVE_AVG}</span></span>
																				</div>
																			</div>
							...
							<div class="row my-3">
								<div class="col">
									<div class="row mx-5 mt-5">
										<div class="col px-4 fs-5 fw-bold">#${restaurantPerHashtag.hashtagDto.hashtag_name }</div>
									</div>
									<div class="row">
										<div class="col">
											<div id="carouselTopHashtag${restaurantPerHashtag.hashtagDto.hashtag_pk}" class="carousel slide"
												data-bs-touch="false">
												<button
													class="carousel-control-prev rounded-circle bg-dark my-auto"
													style="width: 50px; height: 50px;" type="button"
