...
<body>
	...
	<div class="row bg-light" id="searchResultBox">
		...
		<div class="col-6 my-3 me-auto ms-3">
			...
			<div class="row bg-white my-3 px-3 py-3">
				<div class="col">
					<div class="row py-1">
						<div class="col">
							<span class="me-2"><i class="fas fa-map-marker-alt"></i></span> <span>${restaurantData.restaurantDto.address_name }</span>
						</div>
					</div>
					<div class="row py-1">
						<div class="col">
										...
										<div class="row px-3 pt-3">
											<div class="col">
												<c:forEach items="${reviewData.reviewImagesDtoList }"
													var="reviewImagesDto">
													<img style="width: 140px; height: 90px; object-fit: cover;"
														src="/yumbotFiles/review_images/${reviewImagesDto.review_images_link }">
												</c:forEach>
											</div>
										</div>
	...
	<script type="text/javascript">
		var restaurantData=${restaurantData.jsonData};
		let memberUser=null;
		if(${!empty memberUser}){
			memberUser=JSON.parse(${memberUser});
		}
	</script>
	<script src="/yumbot/resources/js/restaurantDetail.js"></script>
